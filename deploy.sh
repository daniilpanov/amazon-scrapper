#!/usr/bin/env bash
docker image rm --force danielgreen1806/amascrap-simple_server:latest danielgreen1806/amascrap-light:latest danielgreen1806/amascrap-google:latest danielgreen1806/amascrap-s3:latest
